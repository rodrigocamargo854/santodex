...
export const saintDetails: { [id: string]: Slide[] } = {
 ...
 'carlo-acutis': [
  ...
  },
  {
    ...
    text: 'Apaixonado por tecnologia, Carlo usava seus conhecimentos em informática para evangelizar. Criou o site oficial sobre milagres eucarísticos (https://www.miracolieucaristici.org) com mais de 160 casos documentados ao redor do mundo, com o objetivo de levar as pessoas a valorizarem mais a Eucaristia, que ele chamava de “minha estrada para o céu”.'
  },
  {
  ...
  "santo-elias": [
    {
      title: "Profeta e Inspirador",
      text: "Santo Elias, o Profeta, é considerado o pai espiritual dos carmelitas, modelo de oração, coragem e fidelidade a Deus."
    },
    {
      title: "Monte Carmelo",
      text: "Foi no Monte Carmelo que Elias defendeu a fé no Deus único, enfrentando os profetas de Baal e reacendendo a chama da confiança em Javé."
    }
  ],
  
  "santa-madalena-pazzi": [
    {
      title: "Experiências Místicas",
      text: "Santa Maria Madalena de Pazzi teve êxtases, visões e locuções interiores, que a levaram a profunda união com Deus."
    },
    {
      title: "Vida de Oração",
      text: "Seu amor ardente a Jesus a tornou exemplo de entrega total e intensa vida de oração no Carmelo."
    }
  ],
  "santa-elisabete-trindade": [
    {
      title: "Trindade Santa",
      text: "Santa Elisabete viveu centrada no mistério da Trindade, chamando-se 'louvora da glória de Deus'."
    },
    {
      title: "Espiritualidade Carmelita",
      text: "Seu legado inspira a busca pela presença de Deus no silêncio e na contemplação diária."
    }
  ],
  "santa-teresa-margarida-redi": [
    {
      title: "Infância Espiritual",
      text: "Santa Teresa Margarida destacou-se pela humildade e simplicidade, semelhante à pequena via de Santa Teresinha."
    },
    {
      title: "Caridade e Pureza",
      text: "Suportou doenças com paciência e ofereceu sua vida pela salvação das almas."
    }
  ],
  "santa-edith-stein": [
    {
      title: "Filósofa e Mística",
      text: "Edith Stein, intelectual brilhante, converteu-se ao catolicismo ao ler Santa Teresa d’Ávila."
    },
    {
      title: "Mártir da Fé",
      text: "Entrou no Carmelo como Teresa Benedita da Cruz e morreu em Auschwitz, oferecendo sua vida pelos judeus e pela paz."
    }
  ],
  "beata-mariam-baouardy": [
    {
      title: "Humildade e Simplicidade",
      text: "Mariam viveu extraordinária união com Deus, marcada por milagres e dons místicos."
    },
    {
      title: "Obra no Carmelo",
      text: "Ajudou a fundar o Carmelo de Belém, permanecendo fiel à vida de oração e sacrifício."
    }
  ],
  "beata-ana-sao-bartolomeu": [
    {
      title: "Discípula de Teresa",
      text: "Foi fiel companheira e enfermeira de Santa Teresa, desempenhando papel fundamental na expansão da reforma carmelita."
    },
    {
      title: "Fundadora",
      text: "Fundou vários conventos na França e na Bélgica, propagando a espiritualidade do Carmelo."
    }
  ],
  "beata-maria-felicia": [
    {
      title: "Jovem de Deus",
      text: "Conhecida como 'Chiquitunga', irradiava alegria, serviço e amor a Jesus na vida cotidiana."
    },
    {
      title: "Exemplo de Santidade",
      text: "Mesmo jovem, ofereceu sua vida com generosidade, tornando-se exemplo para os jovens católicos."
    }
  ],
  "sao-joao-cruz": [
    {
      title: "Vida e Reforma",
      text: "São João da Cruz trabalhou com Santa Teresa d’Ávila na reforma do Carmelo, buscando uma vida mais austera e contemplativa."
    },
    {
      title: "Mística e Escritos",
      text: "É autor de obras clássicas da espiritualidade, como 'A Noite Escura' e 'Subida do Monte Carmelo', que marcaram a mística cristã."
    },
    {
      title: "Frase",
      text: "“Não se contentar com o que diz o confessor é orgulho e falta de fé.”"
    },
    {
      title: "Frase",
      text: "“A mosca que pousa no mel não pode voar; a alma que fica presa ao sabor do prazer sente-se impedida em sua liberdade e contemplação.”"
    },
    {
      title: "Frase",
      text: "“O mais leve movimento de uma alma animada de puro amor é mais proveitoso à Igreja do que todas as demais obras reunidas.”"
    },
    {
      title: "Frase",
      text: "“Por causa de prazeres passageiros, sofrem-se grandes tormentos eternos.”"
    },
    {
      title: "Frase",
      text: "“Meus são os Céus e minha é a Terra, meus são os homens, e os justos são meus; e meus os pecadores. Os Anjos são meus, e a Mãe de Deus, todas as coisas são minhas. O próprio Deus é meu e para mim, pois Cristo é meu e tudo para mim.” (Sobre a Eucaristia)"
    },
    {
      title: "Frase",
      text: "“Não faça coisa nenhuma nem diga palavra que Cristo não faria ou não diria se encontrasse as mesmas circunstâncias.”"
    },
    {
      title: "Frase",
      text: "“Renuncie aos desejos e encontrará o que seu coração deseja.”"
    },
    {
      title: "Frase",
      text: "“Que felicidade o homem poder libertar-se de sua sensualidade! Isso não pode ser bem compreendido, a meu ver, senão por quem o experimentou.”"
    },
    {
      title: "Frase",
      text: "“Quem se queixa ou murmura não é cristão perfeito, nem mesmo um bom cristão.”"
    },
    {
      title: "Frase",
      text: "“Senhor, quero padecer e ser desprezado por amor de Vós.”"
    },
    {
      title: "Frase",
      text: "“A pessoa que está presa por afeto a alguma coisa, mesmo pequena, não alcançará a união com Deus, mesmo que tenha muitas virtudes.”"
    },
    {
      title: "Frase",
      text: "“Para possuir Deus plenamente é preciso nada ter, porque, se o coração pertence a Ele, não pode se voltar para outro.”"
    },
    {
      title: "Frase",
      text: "“O demônio teme a alma unida a Deus como ao próprio Deus.”"
    },
    {
      title: "Frase",
      text: "“O afeto e o apego da alma à criatura torna-a semelhante a essa mesma criatura.”"
    },
    {
      title: "Frase",
      text: "“A pessoa que caminha para Deus e não afasta de si as preocupações, nem domina suas paixões, caminha como quem empurra um carro encosta acima.”"
    },
    {
      title: "Frase",
      text: "“A constância de ânimo, com paz e tranquilidade, ajuda muito a julgar melhor as adversidades.”"
    },
    {
      title: "Frase",
      text: "“O amor não consiste em sentir grandes coisas, mas em se despojar e sofrer pelo amado.”"
    },
    {
      title: "Frase",
      text: "“O progresso da pessoa é maior quando ela caminha às escuras e sem saber.”"
    },
    {
      title: "Frase",
      text: "“Deus quer mais de ti um mínimo de obediência e docilidade do que todas as ações que realizas por Ele.”"
    },
    {
      title: "Frase",
      text: "“Mesmo carregado de grandes e molestas tentações, o homem pode ir a Deus, desde que sua razão e vontade não consintam nelas.”"
    },
    {
      title: "Frase",
      text: "“Queira torna-te, no padecer, algo semelhante a este nosso grande Deus, humilhado e crucificado.”"
    },
    {
      title: "Frase",
      text: "“Quando a alma se acha livre e purificada de tudo, em união com Deus, nenhuma coisa poderá aborrecê-la.”"
    },
    {
      title: "Frase",
      text: "“Tal é a alma que está enamorada de Deus: não pretende vantagem ou prêmio, a não ser perder tudo e a si mesma por Deus.”"
    },
    {
      title: "Frase",
